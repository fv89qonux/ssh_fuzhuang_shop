...
<img width="980" height="100" src=" <%=path %>/images/banner4.jpg ">
  ...
  <tr>
	  <td width="980" height="48"  style="background-color:#20B2AA">&nbsp;&nbsp;&nbsp;&nbsp;
	    ...
	    <a href="<%=path %>/goodsAllYesTejia.action" style="color:#fff;font-size:14px;font-weight:bold">特价区域</a>&nbsp;|&nbsp;
		  <a href="<%=path %>/xinwenManaQian.action" style="color:#fff;font-size:14px;font-weight:bold">穿搭小知识</a>&nbsp;|&nbsp;
	    ...
	    <a onclick="dingAll()" href="#" style="color:#fff;font-size:14px;font-weight:bold">我的定制</a>&nbsp;|&nbsp;
		  ...
		  <a target="_blank" href="/ssh_fuzhuang_shop/login.jsp" style="color:#fff;font-size:14px;font-weight:bold">管理员登录</a>
    </td>
