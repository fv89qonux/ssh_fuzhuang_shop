	  ...
	  <tr>
	    <td style='padding-left:3px;padding-top:8px' valign="top">
			...
			<c:if test="${sessionScope.userType==0}">
				...
				<!-- 1 -->
				<dl class='bitem'>
					<dt onClick='showHide("items5_1")'><b>服装管理</b></dt>
					<dd style='display:block' class='sitem' id='items5_1'>
						<ul class='sitemu'>
							<li><a href='<%=path %>/catelogMana.action' target='main'>服装类别管理</a> </li>
							<li><a href='<%=path %>/pinpaiMana.action' target='main'>服装品牌管理</a> </li>
							<li><a href='<%=path %>/goodsManaNoTejia.action' target='main'>服装管理</a> </li>
							<li><a href='<%=path %>/admin/goods/goodsNoTejiaAdd.jsp' target='main'>添加服装</a> </li>
						</ul>
					</dd>
				</dl>
				<!-- 1 -->
				...
				<!-- 1 -->
				<dl class='bitem'>
					<dt onClick='showHide("items555_1")'><b>穿搭小知识管理</b></dt>
					<dd style='display:block' class='sitem' id='items555_1'>
						<ul class='sitemu'>
							<li><a href='<%=path %>/leibieMana.action' target='main'>知识类别管理</a> </li>
							<%--<li><a href='<%=path %>/pinpaiMana.action' target='main'>服装品牌管理</a> </li>--%>
							<li><a href='<%=path %>/xinwenMana.action' target='main'>穿搭小知识管理</a> </li>
							<%--<li><a href='<%=path %>/admin/goods/goodsNoTejiaAdd.jsp' target='main'>添加服装</a> </li>--%>
						</ul>
					</dd>
				</dl>
